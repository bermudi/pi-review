...
| Gate 1 — public Pi SDK feasibility | `verified` | `bun run verify:sdk-feasibility` | `d4ed9c422876178777cbab9d0f1899329f0ad176` | `verification/blackbox` 7 fixtures 10 assertions, pack `a8e518c6`, artifacts `/tmp/verify-sdk-*` |
