...
// localPath test/ocr-v193/scan/batch.test.ts -> internal/scan/batch_test.go
...
import {
  ...
  BatchByLanguage,
  BatchByDirectory,
} from "../../../src/ocr-v193/scan/batch.js";
...
describe("ocr-v193 scan batch (ported from internal/scan/batch_test.go)", () => {
