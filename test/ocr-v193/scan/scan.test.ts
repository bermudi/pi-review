...
import { loadDefaultScanTemplate, applyLanguageScan } from "../../../src/ocr-v193/template/template.js";
import { mainTaskToolDefs } from "../../../src/ocr-v193/tool/tools-config.js";
import { FileReader, FileReadProvider, CodeSearchProvider, FileFindProvider } from "../../../src/ocr-v193/tool/filereader.js";
import { Registry } from "../../../src/ocr-v193/tool/definitions.js";
import { ModeWorkspace } from "../../../src/ocr-v193/diff/git.js";
...
function makeRegistry(repoDir: string): import("../../../src/ocr-v193/llmloop/types.js").ToolRegistryLike {
  ...
  registry.Freeze();
  return registry as unknown as import("../../../src/ocr-v193/llmloop/types.js").ToolRegistryLike;
}
