...
import { ListSessions, LoadDetail, LoadSummary } from "../../../src/ocr-v193/session/resume.js";
import {
  InputModeWorkspace,
  FailureProvider,
  StatePartial,
...
} from "../../../src/ocr-v193/session/manifest.js";
import type { LlmComment } from "../../../src/ocr-v193/model/review.js";
import type { CoverageItem } from "../../../src/ocr-v193/session/manifest.js";
...
describe("ocr-v193 session list", () => {
  ...
  test("LoadDetail returns items", () => {
    ...
    try {
      ...
      const byType = new Map<string, import("../../../src/ocr-v193/session/resume.js").ItemDetail>();
  ...
  test("LoadSummary ignores unknown manifest version", () => {
    ...
    try {
      ...
      } as unknown as import("../../../src/ocr-v193/session/manifest.js").RunManifest);
      const finErr = sh.Finalize();
      expect(finErr).toBeNull();
      const summary = LoadSummary(repoDir, sh.sessionId);
      expect(summary.legacy).toBe(true);
