...
import { resolveIdentity } from "../../../src/ocr-v193/agent/identity.js";
...
async function runPathIdentity(args: Record<string, unknown>): Promise<import("../../../src/ocr-v193/agent/identity.js").RunIdentity> {
  ...
  const anyAgent = agent as unknown as { filterDiffs: (d: unknown[]) => unknown[]; filterLargeDiffs: (d: unknown[]) => unknown[]; diffs: unknown[]; runIdentity: () => import("../../../src/ocr-v193/agent/identity.js").RunIdentity };
...
describe("ocr-v193 agent sealed input (ported from internal/agent/sealed_input_test.go)", () => {
