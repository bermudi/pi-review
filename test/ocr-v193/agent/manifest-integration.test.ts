...
import { Agent, reviewItemFingerprint } from "../../../src/ocr-v193/agent/agent.js";
...
import { FailureProvider, FailureTimeout, FailurePanic, FailureBudget, StateComplete, StatePartial, StateFailed, StateSkipped } from "../../../src/ocr-v193/session/manifest.js";
...
async function finish(agent: Agent): Promise<import("../../../src/ocr-v193/session/manifest.js").RunManifest> {
  ...
  const m = (agent as unknown as { RunManifest: () => import("../../../src/ocr-v193/session/manifest.js").RunManifest | null }).RunManifest();
  if (!m) throw new Error("no manifest");
  return m;
}

describe("ocr-v193 agent manifest integration (ported)", () => {
