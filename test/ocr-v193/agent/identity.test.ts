...
import { Agent, hashFields } from "../../../src/ocr-v193/agent/agent.js";
...
describe("ocr-v193 agent identity (ported from internal/agent/identity_test.go)", () => {
  ...
  test("TestResolveIdentityMatchesRunPath", async () => {
    ...
    const { Agent: AgentClass } = await import("../../../src/ocr-v193/agent/agent.js");
