...
import { Agent, hashFields, reviewItemFingerprint, manifestItemID } from "../../../src/ocr-v193/agent/agent.js";
...
describe("ocr-v193 agent manifest hash (ported from internal/agent/manifest_hash_test.go)", () => {
