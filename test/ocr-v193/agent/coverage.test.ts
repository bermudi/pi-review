...
// localPath test/ocr-v193/agent/coverage.test.ts -> internal/agent/coverage_test.go

import { describe, test, expect } from "bun:test";
import * as fs from "node:fs";
import * as os from "node:os";
import * as path from "node:path";
import { Agent, errMainTaskEmpty, classifyItemError, NewCommentWorkerPool } from "../../../src/ocr-v193/agent/agent.js";
...
import { DiffMap, FileReadDiffProvider } from "../../../src/ocr-v193/tool/filereader.js";
import { loadDefaultSystemRule } from "../../../src/ocr-v193/rules/system_rules.js";
import { FailureTimeout, FailureCancelled, FailureConfiguration, FailureProvider, FailureBudget } from "../../../src/ocr-v193/session/manifest.js";
...
describe("ocr-v193 agent coverage (ported)", () => {
  ...
  test("TestResolveSystemRule", () => {
    ...
    const resolver = {
      resolve: (p: string): string => {
        const mod = require("../../../src/ocr-v193/rules/system_rules.js") as typeof import("../../../src/ocr-v193/rules/system_rules.js");
