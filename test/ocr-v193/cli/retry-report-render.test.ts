...
import { serializeRetryReport } from "../../../src/ocr-v193/retry/serializer.js";
import { outputRetryReportText, retryAttemptChain } from "../../../src/ocr-v193/cli/output.js";
import {
...
function retryReportFixture(): import("../../../src/ocr-v193/retry/types.js").RetryReport {
  return {
