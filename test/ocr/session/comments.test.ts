...
import { LoadComments } from "../../../src/ocr/session/resume.js";
...
describe("ocr session comments", () => {
  ...
  test("LoadComments returns comments in order", () => {
    ...
    try {
      ...
      sh.RecordReviewItemDone("a.go", "a.go", "a.go", "fp-a", [
        { path: "a.go", content: "first", severity: "high", category: "bug" } as unknown as import("../../../src/ocr/model/review.js").LlmComment,
        { path: "", content: "second, no path", severity: "low" } as unknown as import("../../../src/ocr/model/review.js").LlmComment,
      ]);
      sh.RecordReviewItemReused("b.go", "b.go", "b.go", "fp-b", "prior-session", [
        { path: "b.go", content: "cached", severity: "medium" } as unknown as import("../../../src/ocr/model/review.js").LlmComment,
      ]);
  ...
  test("LoadComments later checkpoint supersedes", () => {
    ...
    try {
      ...
      attachWriter(sh);
      sh.RecordReviewItemDone("a.go", "a.go", "a.go", "fp-a", [
        { path: "a.go", content: "stale" } as unknown as import("../../../src/ocr/model/review.js").LlmComment,
      ]);
      sh.RecordReviewItemDone("a.go", "a.go", "a.go", "fp-a", [
        { path: "a.go", content: "fresh" } as unknown as import("../../../src/ocr/model/review.js").LlmComment,
      ]);
      sh.RecordReviewItemDone("b.go", "b.go", "b.go", "fp-b", [
        { path: "b.go", content: "kept" } as unknown as import("../../../src/ocr/model/review.js").LlmComment,
      ]);
