...
// localPath test/ocr/scan/estimate.test.ts -> internal/scan/estimate_test.go
...
describe("ocr scan estimate (ported from internal/scan/estimate_test.go)", () => {
