...
// localPath test/ocr/scan/dedup.test.ts -> internal/scan/dedup_test.go
...
import * as ScanModule from "../../../src/ocr/scan/scan.js";
type ScanDedup = {
...
describe("ocr scan dedup (ported from internal/scan/dedup_test.go)", () => {
