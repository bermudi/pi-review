...
// localPath test/ocr/scan/getters.test.ts -> internal/scan/getters_test.go

import { describe, test, expect } from "bun:test";
import { Agent } from "../../../src/ocr/scan/scan.js";
import { SessionHistory } from "../../../src/ocr/session/history.js";
import { mkdtemp } from "node:fs/promises";
import { tmpdir } from "node:os";
import { join } from "node:path";
import { scanItemFingerprint, resumedFromSession } from "../../../src/ocr/scan/scan.js";
import type { ScanItem } from "../../../src/ocr/model/scan.js";
import { ResumeState } from "../../../src/ocr/session/resume.js";

describe("ocr scan getters (ported)", () => {
