...
// localPath test/ocr/scan/provider.test.ts -> internal/scan/provider_test.go
...
import { Provider, NewProvider } from "../../../src/ocr/scan/provider.js";
import { __test as providerTest } from "../../../src/ocr/scan/provider.js";
...
describe("ocr scan provider (ported from internal/scan/provider_test.go)", () => {
