...
// localPath test/ocr/scan/retry-identity.test.ts -> internal/scan/retry_identity_test.go
...
describe("ocr scan retry identity (ported from internal/scan/retry_identity_test.go)", () => {
  ...
  test("TestScanRequestsCarryNoIdentity", async () => {
    ...
    // subtest: project summary
    {
      ...
      const a = newProbeAgent(tpl, client, undefined);
      const priv = a as unknown as { maybeRunProjectSummary: (comments: import("../../../src/ocr/model/review.js").LlmComment[]) => Promise<void> };
    ...
    // subtest: dedup
    {
      ...
      collector.add({ path: "a.go", content: "dup 1" } as unknown as import("../../../src/ocr/model/review.js").LlmComment);
      collector.add({ path: "a.go", content: "dup 2" } as unknown as import("../../../src/ocr/model/review.js").LlmComment);
      collector.add({ path: "b.go", content: "unique" } as unknown as import("../../../src/ocr/model/review.js").LlmComment);
      const client = new IdentityProbeClient();
