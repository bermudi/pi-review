...
import { runScanContext } from "../../../src/ocr/cli/scan.js";
import type { CliIo } from "../../../src/ocr/cli/shared.js";
...
describe("ocr scan budget boundary — black-box exit code", () => {
  test("budget-truncated scan via CLI returns partial (2) not clean (0)", async () => {
    ...
    try {
      ...
      const firstComments = await (agent as unknown as { run: (s?: AbortSignal) => Promise<import("../../../src/ocr/model/review.js").LlmComment[]> }).run(new AbortController().signal) as unknown as import("../../../src/ocr/model/review.js").LlmComment[];
      ...
      } as unknown as import("../../../src/ocr/cli/scan.js").ScanRunner;
      ...
      const exitCode = await runScanContext({
        io,
        opts: { outputFormat: "json", preview: false, resume: "", model: "test", maxTokensBudget: 120000 } as unknown as import("../../../src/ocr/cli/shared.js").ScanOptions,
        traceId: "test-trace",
  ...
  test("unlimited budget scan returns clean (0) when all files succeed", async () => {
    ...
    try {
      ...
      const exitCode = await runScanContext({
        io,
        opts: { outputFormat: "json", preview: false, resume: "", model: "test" } as unknown as import("../../../src/ocr/cli/shared.js").ScanOptions,
        traceId: "test-trace",
        llmIdentity: undefined,
        startMs: Date.now(),
